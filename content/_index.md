...
sections:
  - block: resume-biography-3
    content:
      username: me
      # 在这里用安全的文本区，强制放入简介、完美相等的双按钮、照片和视频
      text: |
        ...
        <div style="margin-top: 30px; margin-bottom: 30px;">
          <a href="uploads/resume.pdf" target="_blank" style="display: inline-block; padding: 12px 24px; margin-right: 15px; margin-bottom: 10px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">📄 下载中文简历 (Download CV)</a>
